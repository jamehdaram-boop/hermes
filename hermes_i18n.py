...
MESSAGES = {
    "fa": {
        ...
        "day": "روز",
        "hour": "ساعت",
        "gate_blocked_title": "\U0001F6D1 عملیات توسط Policy Gate مسدود شد",
        "gate_category_destructive": "حذف/مخرب",
        "gate_category_financial": "مالی/پرداخت",
        "gate_label_action": "عملیات",
        "gate_label_description": "توضیح",
        "gate_label_what": "چه چیزی",
        "gate_label_amount": "مبلغ",
        "gate_label_where": "کجا",
        "gate_label_why": "چرا",
        "gate_label_approval_id": "شناسه تأیید",
        "gate_footer": "این عملیات اجرا نشد و منتظر تأیید صریح شما می‌ماند.",
        "task_failed_title": "\U0001F6A8 اجرای کار ناموفق بود",
        "task_label_request": "درخواست",
        "task_label_error": "خطا",
    },
    "en": {
        ...
        "day": "d",
        "hour": "h",
        "gate_blocked_title": "\U0001F6D1 Action blocked by Policy Gate",
        "gate_category_destructive": "destructive/delete",
        "gate_category_financial": "financial/payment",
        "gate_label_action": "action",
        "gate_label_description": "description",
        "gate_label_what": "what",
        "gate_label_amount": "amount",
        "gate_label_where": "where",
        "gate_label_why": "why",
        "gate_label_approval_id": "approval_id",
        "gate_footer": "This action was NOT executed and is waiting for your explicit approval.",
        "task_failed_title": "\U0001F6A8 Task execution failed",
        "task_label_request": "request",
        "task_label_error": "error",
    },
    "ja": {
        ...
        "day": "日",
        "hour": "時間",
        "gate_blocked_title": "\U0001F6D1 Policy Gate によりブロックされました",
        "gate_category_destructive": "削除/破壊的操作",
        "gate_category_financial": "金銭/支払い",
        "gate_label_action": "アクション",
        "gate_label_description": "説明",
        "gate_label_what": "内容",
        "gate_label_amount": "金額",
        "gate_label_where": "場所",
        "gate_label_why": "理由",
        "gate_label_approval_id": "承認ID",
        "gate_footer": "この操作は実行されませんでした。明示的な承認をお待ちしています。",
        "task_failed_title": "\U0001F6A8 タスクの実行に失敗しました",
        "task_label_request": "リクエスト",
        "task_label_error": "エラー",
    },
}
